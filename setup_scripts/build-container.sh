...
DEFAULT_RADSECPROXY_CONFIG_TEMPLATE=$HOME/radsecproxy/config/radsecproxy.conf
DEFAULT_RADSECPROXY_CONTAINER_NAME=radsecproxy
DEFAULT_RADSECPROXY_IMAGE_NAME=cloudteamrahi48303/radsecproxy-alpine:latest
